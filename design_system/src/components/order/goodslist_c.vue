<template>
  ...
  <div>
    ...
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>货架信息列表</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="shelvesid" label="货架号" width="130" show-overflow-tooltip></el-table-column>

        <el-table-column prop="shelvesname" label="货架类别" width="130" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="primary"
              icon="el-icon-edit"
              @click="dialogFormVisibleEdit = true;showEdit(scope.row.id)"
            >修改</el-button>
            <!-- 删除 -->
            <el-button
              size="mini"
