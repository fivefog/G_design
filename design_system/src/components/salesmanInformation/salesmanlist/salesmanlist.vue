...
<div>
    ...
    <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>售货员信息管理</el-breadcrumb-item>
        <el-breadcrumb-item>售货员信息列表</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
        <el-row :gutter="12" class="box-searchRow">
            ...
            <el-col :span="8">
                <el-input placeholder="请输入您要查询的内容" v-model="query.search" clearable @clear="getSalesmanList">
            ...
            <el-col :span="2.5">
                <div class="grid-content bg-purple">
                    <el-button type="success" @click="addSalesman">添加售货员信息</el-button>
                </div>
            </el-col>
        ...
        <!-- 售货员信息表格区域-->
        <el-table :data="salesmanList" height="335" style="width: 100%" border stripe class="box-table" @selection-change="handleSelectionChange" @select-all="handleSelectAll" @select="selected">
            ...
            <el-table-column prop="xueli" label="学历" width="70">
            </el-table-column>
        ...
        <!-- 修改售货员信息的对话框 -->
        <el-dialog title="修改售货员信息" :visible.sync="dialogFormVisibleEdit" width="600px" @close="editDialogClosed" status-icon>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="editSalesman" v-preventReClick>确 定</el-button>
            </div>
        </el-dialog>
    </el-card>
</div>
