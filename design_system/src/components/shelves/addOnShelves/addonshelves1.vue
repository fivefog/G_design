      ...
      >
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item class="addonshelves_input" label="商品编号" prop="on_id">
              <el-input v-model="addOnShelvesForm.on_id" ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="9" :offset="6">
            <el-form-item label="商品编号" prop="g_id">
              <el-select
                ...
                v-model="addOnShelvesForm.g_id"
                filterable
                placeholder="请选择商品编号"
                clearable
                @clear="clearGoodData"
              >
                <el-option v-for="item in g_iddata" :key="item.g_id" :value="item.g_id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="商品名称" prop="g_name">
              <el-input class="addonshelves_input" v-model="addOnShelvesForm.g_name" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="商品规格" prop="g_unit">
              <el-input class="addonshelves_input" v-model="addOnShelvesForm.g_unit" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="商品类别" prop="c_name">
              <el-input class="addonshelves_input" v-model="addOnShelvesForm.c_name" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="非会员价格" prop="price">
              <el-input
                class="addonshelves_input"
                v-model="addOnShelvesForm.price"
                placeholder="请输入非会员价格"
                clearable
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="会员价格" prop="vipprice">
              <el-input
                class="addonshelves_input"
                v-model="addOnShelvesForm.vipprice"
                placeholder="请输入会员价格"
                clearable
              ></el-input>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="上架数量" prop="on_num">
              <el-input
                class="addonshelves_input"
                v-model="addOnShelvesForm.on_num"
                placeholder="请输入上架数量"
                clearable
              ></el-input>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="9" :offset="6">
            <el-form-item label="备注">
              <el-input
                class="addonshelves_input"
                v-model="addOnShelvesForm.on_note"
                placeholder="请输入备注"
                clearable
              ></el-input>
            </el-form-item>
...
export default{
      data() {
        ...
        return {
            ...
            imgurl: '', //商品图片重置前的图片路径
            addOnShelvesRules: { //修改信息的校验证规则对象
                on_id: [
                    { validator: checkOn_id, trigger: 'change' }
                ],
                g_id: [{
                        required: true,
                        message: '请选择商品编号',
    ...
    methods: {
        ...
        fetchOn_id() {
            ...
            this.addOnShelvesForm.on_id = parseInt(on_id)
                // console.log(this.addOnShelvesForm.on_id)
        },
        //获取当前日期
        fetchDate() {
        ...
        async addOnShelves() { //添加上架商品
            ...
            this.$refs.addOnShelvesRef.validate(async(valid) => { //校验
                if (valid) { //校验成功获取添加上架商品的请求
                    try {
                        let {
                            data
                        } = await this.$http.post('/addonshelves', {
                                on_id,
                                g_id,
                                shelvesid,
                                g_name,
