...
<div>
    ...
    <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>下架商品列表</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
        <el-row :gutter="12" class="box-searchRow">
           <el-col :span="1.1" class="condition">
            ...
            <el-col :span="8">
                <el-input placeholder="请输入您要查询的内容" v-model="query.search" clearable @clear="getdownShelvesList">
                    <el-button slot="append" icon="el-icon-search" @click="search" v-preventReClick>查询</el-button>
                </el-input>
            </el-col>
            <el-col :span="2.5">
                <div class="grid-content bg-purple">
                    <el-button type="success" @click="adddownShelvesList">添加下架商品</el-button>
                </div>
            </el-col>
        ...
        <!-- 下架商品表格区域-->
        <el-table :data="downShelvesList" height="335" style="width: 100%" border stripe class="box-table" @selection-change="handleSelectionChange" @select-all="handleSelectAll" @select="selected">
            ...
            <el-table-column prop="down_id" label="下架编号" width="130" show-overflow-tooltip fixed>
            </el-table-column>
            ...
            <el-table-column prop="down_num" label="下架数量" width="110" show-overflow-tooltip>
            </el-table-column>

            <el-table-column label="下架日期" width="110">
                <!-- 
                ...
                <template slot-scope="scope">
                    <!-- 处理日期 格式-->
                    {{scope.row.down_datetime | fmtdata}}
                </template>
            </el-table-column>

            <el-table-column prop="down_note" label="备注" width="120" show-overflow-tooltip>
            </el-table-column>
        ...
        <!-- 修改下架商品信息的对话框 -->
        <el-dialog title="修改下架商品信息" :visible.sync="dialogFormVisibleEdit" width="600px" @close="editDialogClosed" status-icon>
            <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="120px">
                ...
                <el-form-item label="下架数量:" prop="down_num">
                    <el-input v-model="editForm.down_num" placeholder="请输入下架数量" clearable></el-input>
                </el-form-item>

                <el-form-item label="下架日期:" prop="down_datetime">
                    <el-date-picker v-model="editForm.down_datetime" type="date" placeholder="请选择下架日期" @change="timeChange">
                    </el-date-picker>
                </el-form-item>

                <el-form-item label="备注:">
                    <el-input v-model="editForm.down_note" placeholder="请输入备注" clearable></el-input>
                </el-form-item>

            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click="canceldownShelvesList">取 消</el-button>
                <el-button type="primary" @click="editdownShelvesList" v-preventReClick>确 定</el-button>
            </div>
        </el-dialog>
    </el-card>
</div>
...
<script>
import downshelveslist from './downshelveslist'
export default downshelveslist
</script>
