    ...
    <el-container style="height: 100vh; border: 1px solid #eee" class="el-container">
      ...
      <el-container>
        ...
        <el-main>
          ...
          <keep-alive
            include="myselfUpdate,passUpdate,addadmin,addsalesman,addvip,addsupplier,addenterstock,addoutstock,addreturngoods,addonshelves,adddownshelves,addsale"
          >
            <router-view />
          </keep-alive>
        </el-main>
