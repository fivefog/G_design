    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="vip-card-box">
				...
				<text class="e-m">熊猫优选</text>
				<text class="e-b">By 2hang</text> 
			</view>
		</view>
		...
		>
			...
			<!-- 	<view class="sec-header">
				...
				<list-cell icon="icon-shezhi1" iconColor="#ee883b" title="设置" border="" @eventClick="navTo('/pages/set/set')"></list-cell>
			</view>
		</view>
